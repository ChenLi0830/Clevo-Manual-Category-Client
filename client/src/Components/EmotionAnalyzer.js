...
export default compose(
    ...
    withHandlers({
      ...
      getToken: props => (apiKey, options) => {
        return Promise.resolve("token is not needed");
      },
                  ...
                  .then(result => {
                    ...
                    for (let segment of result.result.analysisSegments) {
                      ...
                      let record = {
                        ...
                        group11: `${mood11.Primary.Phrase} / ${mood11.Secondary.Phrase} (${moodValue11})`,
                        group21: `${mood21.Primary.Phrase} / ${mood21.Secondary.Phrase} (${moodValue21})`,
                      };
